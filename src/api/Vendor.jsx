...
//     cityId: null,
//     zipCode: null,
//     bankAcctName: null,        // Updated field name
//     bankAccountNum: null,      // Updated field name
//     bankName: null,
//     bankBranchName: null,      // Updated field name
//     bankSwiftCode: null,       // Updated field name
//     createdBy: null,
//     documentList: null,
//     postalCode: 0,
//     contactList: [
//       { name: "", email: "", mobileNo: "", isDefault: "" }    // Updated field names
//     ]
//   });
...
//   const addContactRow = () => {
//     const updated = [...formData.contactList, { name: "", email: "", mobileNo: "", isDefault: "" }];
...
//                 <div className="custom-select-wrapper">
//                   <Select showSearch placeholder="Choose Currencies" style={{ width: "100%" }} value={formData.currency || undefined} onChange={(value) => handleSelectChange("currency", value)} options={metaCurrencies} className="underline-select" suffixIcon={null} />
//                 </div>
//               </div>
...
//                 </div>
//                 <div className="custom-select-wrapper">
//                   <Select showSearch placeholder="Choose City" style={{ width: "100%" }} value={formData.cityId || undefined} onChange={(value) => handleSelectChange("cityId", value)} options={metaCities.map((city) => ({ value: city.id, label: city.name }))} className="underline-select mt-3" suffixIcon={null} />
//                 </div>
...
//               <div className="card">
//                 <h3>Bank Details</h3>
//                 <input type="text" name="bankAcctName" placeholder="Bank Account Name" value={formData.bankAcctName} onChange={handleChange} />
//                 <input type="text" name="bankAccountNum" placeholder="Bank Account No" value={formData.bankAccountNum} onChange={handleChange} />
//                 <input type="text" name="bankName" placeholder="Bank Name" value={formData.bankName} onChange={handleChange} />
//                 <input type="text" name="bankBranchName" placeholder="Bank Branch Name" value={formData.bankBranchName} onChange={handleChange} />
//                 <input type="text" name="bankSwiftCode" placeholder="Bank Swift Code" value={formData.bankSwiftCode} onChange={handleChange} />
//               </div>
//             </div>
//           )}
//         </div>
...
//                     </td>
//                     <td>
//                       <input type="text" placeholder="Phone No" value={contact.phone} onChange={(e) => updateContactField(index, 'phone', e.target.value)} />
//                     </td>
...
//                     </td>
//                     <td>
//                       <FontAwesomeIcon style={{ color: "red" }} icon={faTrash} onClick={() => deleteContactRow(index)} />
//                     </td>
//                   </tr>
//                 ))}
//               </tbody>
...
const Vendor = () => {
  ...
  const addContactRow = () => {
    const updated = [...formData.contactList, { name: "", email: "", phone: "", isDefault: "" }];
    setFormData({ ...formData, contactList: updated });
  };
  ...
  const createData = () => {
    const updatedFormData = {
      ...
      zipCode: formData.zipCode || formData.postalCode || 0,
    };
